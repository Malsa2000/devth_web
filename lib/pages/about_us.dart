...
class AboutUs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Column(
      ...
      children: [
       SizedBox(height:size.width >900? size.height*0.02 :size.height*0.01,),
        conteainerTitle(AllText.about_us, size, context, 0.35,0),
        Row(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
          ImageController(size ,context ,0.1 , size.width>900? 0.08 :0.15 ,0),
          Column(
            mainAxisAlignment: MainAxisAlignment.start,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Container(
                margin: EdgeInsets.only(left :size.width*0.05 ,top:size.width>900? size.height*0.16: size.height*0.08),
        ...
        ImageController(size ,context ,0.2 ,size.width > 900 ?0.1 : 0.05,0),
        Container(
            margin: EdgeInsets.only(left: size.width * 0.23,top:size.width > 900 ?size.height * 0.12 :size.height * 0.05),
            ...
            child: context.text(text: AllText.aboutUsText3, size: size.width*0.021,
                color: context.textColor ,wieght: FontWeight.w400)
        ),
        Container(
          margin: EdgeInsets.only(top:size.width > 900 ? size.height*0.06:size.height*0.03 ,
          ...
          child: Column(
            children: [
              ...
              SizedBox(height:size.width > 900 ? size.height * 0.07:size.height*0.035,),
              Text(
                'Contact us:',
                style: TextStyle(
                    color: const Color(0xFF3b4d5b),
        ...
        Stack(
          children:[
            Container(
            width: size.width,
            height:size.width > 900 ? size.height * 0.55 :size.height * 0.25,
            alignment: Alignment.center,
            padding: EdgeInsets.only(top:size.width > 900? size.height*0.15 :size.height *0.07,
                bottom:size.width > 900?   size.height*0.05 :size.height* 0),
