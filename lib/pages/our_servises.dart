      ...
      children: [
        ...
        Container(
          ...
          margin: EdgeInsets.only(
            top:size.width > 900 ? size.height * 0.12: size.height*0.05,
        ...
        Container(
          //height: size.width > 900 ?size.height * 0.1:size.height * 0.7,
          alignment: Alignment.center,
          margin: EdgeInsets.only(
          ...
          child: Image(
              image: AssetImage("images/dots.png"),fit: BoxFit.fitWidth),
        ),
        ConstrainedBox(
          constraints: BoxConstraints(
            maxHeight: size.width > 900 ?size.height * 0.7:size.height * 0.23,
            minHeight: size.width > 900 ?size.height * 0.7:size.height * 0.23,
          ),
                ...
                return Stack(
                  children: [
                        ...
                        children: [
                          Container(
                            ...
                            padding: EdgeInsets.only(
                                ...
                                top:size.width > 900 ? size.height * 0.07:size.height*0.03
                            ),
                            decoration: BoxDecoration(
                                boxShadow: const[
                              BoxShadow(color: Colors.black12 ,offset: Offset(3,3) ,blurRadius: 2)
                          ...
                          Positioned(
                              child: Container(
                                ...
                                margin: EdgeInsets.only(top:size.width > 900 ? size.height * 0.015:size.height*0.005),
                                width: size.width * 0.07,
                                height:size.width > 900 ? size.height * 0.035 :size.height*0.017,
                                decoration: BoxDecoration(
                    ...
                    index != 0
                      ...
                      child: Container(
                        margin: EdgeInsets.only(
                          top:  size.width > 900?size.height * 0.14 :size.height * 0.07 ,
                        ),
                        child: Row(
                          children: [
                            context.text(
                            ...
                            Padding(
                              padding: EdgeInsets.only(top:size.width > 900? size.height*0.016 :size.height*0.008),
                              child: CircleAvatar(
